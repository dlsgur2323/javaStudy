...
//		System.out.println(str2.equals(str1));
		...
		str = "0123456789";
		String sub1 = str.substring(3); //3번 인덱스부터 잘라서 반환한다. (3번 포함)
		...
		//substring과 indexOf 를 조합해서 문자열 자르기
		String[] menu = {
				"수박 20000원",
				"오렌지 100000원",
				"귤 500원",
		...
		for(int i = 0; i < menu.length; i++){
			...
			// string 타입을 int 타입으로 바꾸기 => Integer.parseInt(string);
		...
		//사용자의 실수로 아이디나 비밀번호 앞뒤에 공백이 들어가는 것을 방지하기 위해 상요할 수 있다.
		String id = " myid";
